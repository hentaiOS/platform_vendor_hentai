...
if __name__ == '__main__':
    # Default to hentaiOS Gerrit
    default_gerrit = 'https://gerrit.hentaios.com'
    ...
    for item in mergables:
        ...
        if args.gerrit == default_gerrit:
            ...
            if args.pull:
                cmd = ['git pull --no-edit github/hentaiOS', item['fetch'][method]['ref']]
            else:
                cmd = ['git fetch github/hentaiOS', item['fetch'][method]['ref']]
            if args.quiet:
                cmd.append('--quiet')
            else:
                print(cmd)
